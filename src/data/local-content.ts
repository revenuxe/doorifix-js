...
const bangalore: LocalGuide = {
  ...
  services: {
    "washing-machine-repair": { summary: "Bangalore washing machine repair for spin interruptions, drainage faults and leaks. Share the load type, error code and the cycle stage where the machine stops.", advice: "If a washer has been relocated, tell the technician whether the vibration began after the move. For slow filling, note whether other taps are affected too; an inlet restriction and a machine fault need different checks." },
...
const chennai: LocalGuide = {
  ...
  services: {
    "washing-machine-repair": { summary: "Chennai washing machine service for water remaining in the drum, interrupted spin cycles and leaks during filling or washing.", advice: "Mention whether your washer fills normally and whether the fault appears before or after rinsing. If water supply to the home has been interrupted, share that context. Avoid repeated restart attempts when water is leaking near the power connection." },
...
const mangalore: LocalGuide = {
  ...
  services: {
    "washing-machine-repair": { summary: "Mangalore washing machine repair for drum noise, a machine that will not spin, drainage problems and water escaping during a cycle.", advice: "Share whether the machine is fully automatic or semi-automatic and whether washing and spinning both fail. For equipment kept in a utility area, mention visible rust or damaged hoses so the technician can assess condition as well as the immediate fault." },
