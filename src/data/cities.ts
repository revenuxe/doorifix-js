...
export const cities: CityData[] = [
  ...
  },
  {
    slug: "kerala",
    name: "Kerala",
    headline: "Appliance Repair at\nYour Doorstep in Kerala",
    subheadline: "Trusted appliance repair across Kerala including Kochi, Trivandrum, Kozhikode, Thrissur, Kollam, Alappuzha, Kottayam, Kannur & more.",
    metaTitle: "Appliance Repair in Kerala | Washing Machine, AC, Fridge Service Near Me - Doorifix",
    metaDescription: "Best appliance repair in Kerala for washing machines, refrigerators, ACs, microwaves, dryers and dishwashers. Same-day doorstep service by certified Doorifix technicians.",
    keywords: "appliance repair kerala, washing machine repair kerala, fridge repair kerala, AC service kerala, refrigerator repair near me kerala, home appliance repair kerala, doorstep appliance service kerala, microwave repair kerala, dryer repair kerala, dishwasher repair kerala, best appliance repair service kerala",
    heroText: "Kerala's trusted appliance repair network - serving Kochi, Trivandrum, Kozhikode, Thrissur, Kollam and nearby towns with same-day doorstep service.",
    ctaText: "Book a Repair in Kerala",
    appliances: [
      { title: "Washing Machine Repair Kerala", keywords: "washing machine repair near me kerala, front load repair, top load service, IFB LG Samsung Whirlpool repair" },
      { title: "Refrigerator Repair Kerala", keywords: "fridge repair near me kerala, refrigerator not cooling, gas refill, compressor repair, double door fridge service" },
      { title: "AC Repair & Service Kerala", keywords: "AC repair near me kerala, AC gas charging, split AC service, AC not cooling, inverter AC repair" },
      { title: "Microwave Repair Kerala", keywords: "microwave repair near me kerala, microwave not heating, magnetron repair, convection microwave service" },
      { title: "Dryer Repair Kerala", keywords: "dryer repair near me kerala, dryer not drying, heating element repair, drum noise fix" },
      { title: "Dishwasher Repair Kerala", keywords: "dishwasher repair kerala, dishwasher not draining, pump motor repair, Bosch IFB dishwasher service" },
    ],
    faqs: [
      { q: "Do you provide appliance repair across Kerala?", a: "Yes, Doorifix provides doorstep appliance repair across major Kerala cities including Kochi, Trivandrum, Kozhikode, Thrissur, Kollam, Alappuzha, Kottayam, and Kannur." },
      { q: "Can I book same-day washing machine repair in Kerala?", a: "Yes, same-day washing machine repair is available in covered Kerala locations. Our team confirms the nearest technician after your booking." },
      { q: "Which appliances do you repair in Kerala?", a: "We repair washing machines, refrigerators, ACs, microwaves, dryers, dishwashers, and other major home appliances from leading brands." },
      { q: "Do Doorifix technicians carry spare parts?", a: "Technicians carry common spare parts for faster repair. If a special part is needed, we provide a clear quote and timeline before replacement." },
      { q: "Is there warranty on Kerala appliance repairs?", a: "Yes, Doorifix provides service warranty on repairs and replaced parts based on the appliance issue and part category." },
    ],
  },
  {
    slug: "hyderabad",
  ...
  },
  {
    ...
    subheadline: "Trusted home appliance repair & servicing across Bangalore — Whitefield, Koramangala, Indiranagar, HSR Layout, Marathahalli, Electronic City, Jayanagar, JP Nagar, BTM Layout, Hebbal, Yelahanka, HBR Layout & more.",
    metaTitle: "Appliance Repair in Bangalore | Washing Machine, AC, Fridge Repair Near Me – Doorifix",
    metaDescription: "Top-rated appliance repair in Bangalore. Expert washing machine, refrigerator, AC, microwave, dryer & dishwasher repair at your doorstep. Same-day service in Whitefield, Koramangala, Indiranagar, HSR Layout, Marathahalli, Electronic City & all Bangalore areas.",
    keywords: "appliance repair bangalore, washing machine repair bangalore, fridge repair bangalore, AC service bangalore, microwave repair bangalore, appliance repair near me bangalore, home appliance repair whitefield, doorstep repair koramangala, appliance service indiranagar, washing machine repair near me bangalore, refrigerator repair near me bangalore, AC repair near me bangalore, appliance repair HSR layout, appliance service marathahalli, fridge repair electronic city, AC service jayanagar, washing machine repair JP nagar, appliance repair BTM layout, home appliance repair hebbal, appliance service yelahanka, repair near me bangalore, best appliance repair bangalore, same day repair bangalore",
    heroText: "Bangalore's most trusted appliance repair experts — serving Whitefield, Koramangala, Indiranagar, HSR Layout, Marathahalli, Electronic City, Jayanagar, JP Nagar, Hebbal & beyond.",
    ctaText: "Book a Repair in Bangalore",
    appliances: [
      { title: "Washing Machine Repair Bangalore", keywords: "washing machine repair near me bangalore, front load repair whitefield, top load service koramangala, samsung washing machine repair bangalore, lg washing machine repair indiranagar, drum issue fix HSR layout, water leak repair marathahalli, ifb washing machine service bangalore, whirlpool washing machine repair electronic city" },
      { title: "Refrigerator Repair Bangalore", keywords: "fridge repair near me bangalore, fridge not cooling whitefield, refrigerator gas refill bangalore, compressor repair koramangala, double door fridge service indiranagar, samsung fridge repair bangalore, lg refrigerator repair HSR layout, godrej fridge repair jayanagar, whirlpool refrigerator service marathahalli" },
      { title: "AC Repair & Service Bangalore", keywords: "AC repair near me bangalore, AC gas charging whitefield, split AC service koramangala, window AC repair indiranagar, AC installation bangalore, AC deep cleaning HSR layout, daikin AC service bangalore, voltas AC repair marathahalli, AC not cooling bangalore, inverter AC repair electronic city" },
      { title: "Microwave Repair Bangalore", keywords: "microwave repair near me bangalore, microwave not heating whitefield, turntable fix koramangala, magnetron repair indiranagar, samsung microwave repair bangalore, lg microwave service HSR layout, convection microwave repair jayanagar" },
      { title: "Dryer Repair Bangalore", keywords: "dryer repair near me bangalore, dryer not drying whitefield, drum noise fix koramangala, heating element repair indiranagar, samsung dryer repair bangalore, lg dryer service HSR layout, belt repair marathahalli" },
      { title: "Dishwasher Repair Bangalore", keywords: "dishwasher repair near me bangalore, dishwasher not draining whitefield, spray arm fix koramangala, pump motor indiranagar, bosch dishwasher repair bangalore, ifb dishwasher service HSR layout, dishwasher leak repair jayanagar" },
    ],
    faqs: [
      { q: "How quickly can I get appliance repair in Bangalore?", a: "We typically arrive within 60-90 minutes across Bangalore, including Whitefield, Koramangala, Indiranagar, HSR Layout, Marathahalli, and Electronic City areas." },
      { q: "Do you provide washing machine repair in Whitefield & Koramangala?", a: "Yes, we cover all of Whitefield, Koramangala, Indiranagar, HSR Layout, Marathahalli, and the wider Bangalore area for washing machine, fridge, AC, and all major appliance repairs." },
      { q: "What brands do you service in Bangalore?", a: "We service Samsung, LG, Whirlpool, Bosch, IFB, Haier, Godrej, Voltas, Daikin, and all major brands across Bangalore." },
      { q: "Is there a service charge for doorstep repair in Bangalore?", a: "We offer free diagnosis. You only pay for the repair and parts — no hidden charges. Transparent pricing guaranteed across Bangalore." },
      { q: "Which areas in Bangalore do you cover?", a: "We serve Whitefield, Koramangala, Indiranagar, HSR Layout, Marathahalli, Electronic City, Jayanagar, JP Nagar, BTM Layout, Hebbal, Yelahanka, HBR Layout, Banashankari, Rajajinagar, Malleshwaram, Sarjapur Road, Bellandur, and all major Bangalore localities." },
    ],
  },
  {
    slug: "mangalore",
    ...
    subheadline: "Trusted home appliance repair & servicing across Mangalore — Hampankatta, Kadri, Bejai, Kankanady, Bunder, Surathkal, Mangaladevi, Bondel, Pumpwell & more.",
    metaTitle: "Appliance Repair in Mangalore | Washing Machine, AC, Fridge Repair Near Me – Doorifix",
    metaDescription: "Top-rated appliance repair in Mangalore. Expert washing machine, refrigerator, AC, microwave, dryer & dishwasher repair at your doorstep. Same-day service in Hampankatta, Kadri, Bejai, Kankanady, Surathkal & all Mangalore areas.",
    keywords: "appliance repair mangalore, washing machine repair mangalore, fridge repair mangalore, AC service mangalore, microwave repair mangalore, appliance repair near me mangalore, home appliance repair hampankatta, doorstep repair kadri, appliance service bejai, washing machine repair near me mangalore, refrigerator repair near me mangalore, AC repair near me mangalore, appliance repair kankanady, appliance service surathkal, fridge repair bunder, AC service mangaladevi, washing machine repair bondel, best appliance repair mangalore, same day repair mangalore",
    heroText: "Mangalore's most trusted appliance repair experts — serving Hampankatta, Kadri, Bejai, Kankanady, Bunder, Surathkal & beyond.",
    ctaText: "Book a Repair in Mangalore",
    appliances: [
      { title: "Washing Machine Repair Mangalore", keywords: "washing machine repair near me mangalore, front load repair hampankatta, top load service kadri, samsung washing machine repair mangalore, lg washing machine repair bejai, drum issue fix kankanady, water leak repair surathkal, ifb washing machine service mangalore, whirlpool washing machine repair bunder" },
      { title: "Refrigerator Repair Mangalore", keywords: "fridge repair near me mangalore, fridge not cooling hampankatta, refrigerator gas refill mangalore, compressor repair kadri, double door fridge service bejai, samsung fridge repair mangalore, lg refrigerator repair kankanady, godrej fridge repair surathkal" },
      { title: "AC Repair & Service Mangalore", keywords: "AC repair near me mangalore, AC gas charging hampankatta, split AC service kadri, window AC repair bejai, AC installation mangalore, AC deep cleaning kankanady, daikin AC service mangalore, voltas AC repair surathkal, AC not cooling mangalore" },
      { title: "Microwave Repair Mangalore", keywords: "microwave repair near me mangalore, microwave not heating hampankatta, turntable fix kadri, magnetron repair bejai, samsung microwave repair mangalore, lg microwave service kankanady, convection microwave repair surathkal" },
      { title: "Dryer Repair Mangalore", keywords: "dryer repair near me mangalore, dryer not drying hampankatta, drum noise fix kadri, heating element repair bejai, samsung dryer repair mangalore, lg dryer service kankanady, belt repair surathkal" },
      { title: "Dishwasher Repair Mangalore", keywords: "dishwasher repair near me mangalore, dishwasher not draining hampankatta, spray arm fix kadri, pump motor bejai, bosch dishwasher repair mangalore, ifb dishwasher service kankanady, dishwasher leak repair surathkal" },
    ],
    faqs: [
      { q: "How quickly can I get appliance repair in Mangalore?", a: "We typically arrive within 60-90 minutes across Mangalore, including Hampankatta, Kadri, Bejai, Kankanady, Bunder, and Surathkal areas." },
      { q: "Do you provide washing machine repair in Kadri & Hampankatta?", a: "Yes, we cover all of Hampankatta, Kadri, Bejai, Kankanady, Surathkal, and the wider Mangalore area for washing machine, fridge, AC, and all major appliance repairs." },
      { q: "What brands do you service in Mangalore?", a: "We service Samsung, LG, Whirlpool, Bosch, IFB, Haier, Godrej, Voltas, Daikin, and all major brands across Mangalore." },
      { q: "Is there a service charge for doorstep repair in Mangalore?", a: "We offer free diagnosis. You only pay for the repair and parts — no hidden charges. Transparent pricing guaranteed across Mangalore." },
      { q: "Which areas in Mangalore do you cover?", a: "We serve Hampankatta, Kadri, Bejai, Kankanady, Bunder, Surathkal, Mangaladevi, Bondel, Pumpwell, Falnir, Balmatta, Bejai New Road, Lalbagh, Attavar, Derebail, and all major Mangalore localities." },
    ],
  },
];
