          ...
          <div className="px-5 md:px-8 lg:px-12 pt-6 pb-4 space-y-6 md:space-y-8">
            ...
            <div className="flex gap-3 md:hidden">
              <div className="flex items-center gap-2 bg-card rounded-full px-4 py-2 border border-border">
                ...
                <span className="text-xs font-medium text-foreground">Book a Visit</span>
              </div>
            ...
            <LocalRepairContent city={cityData} />

            {/* Washing Machine Brands */}
            {["mangalore", "chennai"].includes(cityData.slug) ? <CityBrandSection citySlug={cityData.slug} /> : <div>
              <div className="flex items-center justify-between mb-4">
                <div>
              ...
              <div className="flex flex-wrap gap-2">
                {washingMachineBrands.map((brand) => (
                  <Link
                    key={brand.slug}
                    href={["mangalore", "chennai"].includes(cityData.slug) ? `/${cityData.slug}/washing-machine/brands/${brand.slug}` : `/washing-machine/brands/${brand.slug}`}
