    ...
    <div className="bg-background min-h-screen flex flex-col">
      <SEO
        ...
        breadcrumbs={[
          ...
          { name: `${service.title} Repair`, url: `/${cityData.slug}/service/${service.slug}` },
        ]}
        structuredData={{
        ...
        <div className="md:grid md:grid-cols-2 md:gap-8 md:px-8 lg:px-0 md:pt-8">
          ...
          <div className="px-5 md:px-0 pt-5 pb-28 md:pb-8 space-y-5">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-foreground">{service.title} Repair in {cityData.name}</h1>
              ...
              <a href="tel:+9109100038182" className="bg-primary text-primary-foreground rounded-xl px-4 py-2.5 text-sm font-semibold flex items-center gap-1.5 hover:opacity-90 transition-opacity flex-shrink-0">
                <Phone size={14} />
                Call Now
              </a>
            </div>
